...
final class MailTemplateService
{
    ...
    private const PLACEHOLDER_OPTIONS = [
        ...
        'Instrucciones de examen' => [
            ...
            'instruction_video_url' => 'URL del video (primer video)',
            'instruction_video_label' => 'Etiqueta del video de instrucciones',
            'instructions_html' => 'Bloque HTML compacto con todos los docs',
            'instruction_docs_html' => 'Lista HTML (<ul>) de todos los documentos/enlaces/videos',
            'doc_*_url' => 'URL de un doc por código (ej. {{doc_temario_url}})',
            'doc_*_label' => 'Etiqueta de un doc por código (ej. {{doc_temario_label}})',
        ],
        'Documentos (enlaces)' => [
        ...
        'Resultados / CENNI' => [
            ...
            'score_report_url' => 'URL score report',
            'results_pdf_url' => 'URL / enlace al PDF de resultados',
            'cancel_reason' => 'Motivo de cancelación del examen',
    ...
    public static function sampleVarsForPlaceholders(array $placeholders): array
    {
        $samples = array_merge(self::uksSolicitudSampleVars(), [
            ...
            'instructions_html' => '<p><a href="#">Guía de acceso al examen</a> · <a href="#">Video de instrucciones</a> · <a href="#">Temario</a></p>',
            'instruction_docs_html' => '<ul style="margin:0;padding-left:1.1rem"><li><a href="#">Guía de acceso al examen</a></li><li><a href="#">Video de instrucciones</a></li><li><a href="#">Temario</a></li></ul>',
            'doc_temario_url' => rtrim((string) (Env::get('APP_URL', '') ?? 'https://pdv.institutodoceo.com'), '/') . '/uploads/groups/1/instructions/temario.pdf',
            'doc_temario_label' => 'Temario',
            'results_level' => 'B2',
            'results_score' => '82',
